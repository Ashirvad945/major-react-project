      ...
      <div className="bg-white shadow-md rounded-3xl px-5 py-6 w-full sm:w-[27vw]">
        ...
        {/* for user name */}
          <div className="mb-4">
            ...
            <input type="text" name="name" id="name" placeholder="ap945" className="shadow-md rounded-md w-full px-3 py-3 border border-gray-300 focus:outline-none
...
{/* for password */}
          ...
          <div className="mb-4">
           ...
           <select className="shadow-md rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none
           focus:ring-black focus:border-black">
          ...
          <Link className="text-xs text-black hover:text-gray-600" to="/login">Logn In With Account</Link>
          </div>
